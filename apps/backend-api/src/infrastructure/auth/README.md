...
A diferencia de `../ai/QwenHintGenerator.ts` → `LangChainChatModel` o de los futuros `Prisma*Repository`, ninguno de los dos depende de red ni base de datos — por eso sí tienen cobertura de test completa, sin gaps aceptados.
